...
/**
 * The task that provides a complete restore of block_chatbot_ollama is defined here.
 *
...
require_once($CFG->dirroot.'//blocks/chatbot_ollama/backup/moodle2/restore_chatbot_ollama_stepslib.php');

/**
 * Restore task for block_chatbot_ollama.
 */
class restore_chatbot_ollama_block_task extends restore_block_task {
